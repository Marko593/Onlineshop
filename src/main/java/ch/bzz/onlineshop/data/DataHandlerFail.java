...
public class DataHandlerFail {
    private static final DataHandlerFail instance = new DataHandlerFail();
    ...
    public static void setPublisherMap(Map<String, Onlineshop> onlineshopMap) {
        DataHandlerFail.onlineshopMap = onlineshopMap;
    }
